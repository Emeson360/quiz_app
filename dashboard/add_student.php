			...
			<ul class="metismenu list-unstyled" id="side-menu">
				...
				<li class="mm-active">
					...
					<ul class="sub-menu" aria-expanded="false">
						...
						<li class="current mm-active"><a href="add_student.php">Add Student</a></li>
					...
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						...
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								...
								<li class="breadcrumb-item active text-white">Add Student</li>
							</ol>
						</div>
				...
				<div class="col-lg-6 mx-auto order-2 order-md-3 order-lg-2 mb-4">
					<div class="card" style="background-color: #082B43;">
						<div class="card-head px-5 py-3" style="background-color: #12659C;">
							<h4 class="fw-normal text-white">Add Student</h4>
						</div>
						<div class="card-body p-0 px-3 py-3">

							<form class="form-horizontal mt-3" method="post" action="<?= ROOT_URL ?>controllers/adminControllers/add_edit_student-logic.php" autocomplete="off">
								...
								<div class="form-group mb-3 text-center row mt-3 pt-1">
									<div class="col-12">
										<button class="btn btn-info w-50 waves-effect waves-light" type="submit" name="add">Add</button>
									</div>
								</div>
